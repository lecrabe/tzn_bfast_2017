...
log_filename <- file.path(example_directory, paste0(format(Sys.time(), "%Y-%m-%d-%H-%M-%S"), "_example_", example_title, ".log"))
...
plot(def_ndmi)
plot(def_ndmi,col="black",main="NDMI deforestation")
